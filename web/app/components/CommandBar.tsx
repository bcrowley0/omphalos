...
const SUGGESTIONS: Suggestion[] = [
  ...
  { verb: "chart", label: "chart <SYMBOL>", hint: "price chart", needsArg: true },
  { verb: "quote", label: "quote <SYMBOL>", hint: "snapshot quote", needsArg: true },
  { verb: "crypto", label: "crypto <PAIR>", hint: "crypto chart, e.g. BTC/USD", needsArg: true },
